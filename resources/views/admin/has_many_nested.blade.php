...
<div id="has-many-{{$column}}" class="has-many-{{$column}}">
                                        ...
                                        <div class="form-group  form-group-xs answer-item">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group input-group-xs">
                                                    ...
                                                    <input type="text" name="questions[{{$pk}}][answer][new_{{$key+1}}][content]" class="form-control answer title" placeholder="Nhập vào Nội dung câu hỏi" value="{{ $answer->content }}">
                                                </div>
                                            </div>
                                            <div class="col-sm-1">
    ...
    <template class="{{$column}}-tpl">
        <div class="has-many-{{$column}}-form fields-group">
            @if (isset($template)){!! $template !!}@endif
            <div class="form-group form-group-{{ config('admin.form-style') }}">
                <div class="col-sm-12">
                    <label class="{{$viewClass['label']}} control-label"></label>
                    <div class="{{$viewClass['field']}}">
